...
// Send the display buffer out to the display
void Adafruit_SSD1306_I2c::display2()
{
	command(SSD1306_SETLOWCOLUMN | 10);  // low col = 0
	command(SSD1306_SETHIGHCOLUMN | 0x0);  // hi col = 0
	command(SSD1306_SETSTARTLINE | 10); // line #0
	sendDisplayBuffer();
}

// Send the display buffer out to the display
void Adafruit_SSD1306_I2c::displayTitle()
{
	command(SSD1306_SETLOWCOLUMN | 0x0);  // low col = 0
	command(SSD1306_SETHIGHCOLUMN | 0x0);  // hi col = 0
	command(SSD1306_SETSTARTLINE | 0x0); // line #0
...
// Send the display buffer out to the display
void Adafruit_SSD1306_I2c::displayOption()
{
	command(SSD1306_SETLOWCOLUMN | 0x0);  // low col = 0
	command(SSD1306_SETHIGHCOLUMN | 0x0);  // hi col = 0
	command(SSD1306_SETSTARTLINE | 0x30); // line #0
	sendDisplayBuffer();
}
